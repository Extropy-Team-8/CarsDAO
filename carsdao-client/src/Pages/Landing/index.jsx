          ...
          <div className="bg-red-700 pt-6">
            ...
            >
              ...
              <div className="hidden md:flex md:items-center md:space-x-6">
                ...
                <a
                  href="#"
                  className="inline-flex items-center px-4 py-2 border border-transparent text-base font-medium rounded-md text-white bg-red-600 hover:text-red-200"
                >
                  Connect Wallet
                </a>
              </div>
                ...
                <div className="mx-auto max-w-md px-4 sm:max-w-2xl sm:px-6 sm:text-center lg:px-0 lg:text-left lg:flex lg:items-center">
                  <div className="lg:py-20">
                    ...
                    <p className="text-base text-red-300 sm:text-xl lg:text-lg xl:text-xl">
                      With the advent of smart-mobiles, your cars are
                      transforming into spying devices.
                      <br />
                      <br />
                      Cars DAO is here to protect you from predatory data
                      practices of car companies.
                    </p>
                ...
                <div className="mt-12 -mb-16 sm:-mb-48 lg:m-0 lg:relative">
                  ...
                  <div className="mx-auto max-w-md px-4 sm:max-w-2xl sm:px-6 lg:max-w-none lg:px-0 flex flex-col items-center justify-center h-full">
                    ...
                    <div className="min-w-0 flex-1 mt-10 flex">
                      ...
                      />
                      <button className="px-6 ml-3 bg-gradient-to-r from-teal-500 to-cyan-600 rounded-md flex-none font-bold text-white">Make Bid</button>
                    </div>
                  </div>
                </div>
              </div>
          ...
          <div className="relative bg-white py-16 sm:py-24 lg:py-24">
            <div className="mx-auto max-w-md px-4 text-center sm:max-w-3xl sm:px-6 lg:px-8 lg:max-w-7xl">
              ...
              <p className="mt-5 max-w-prose mx-auto text-xl text-gray-400">
                  Tesla Motors has collected over <span className="text-gray-700 font-semibold">1.5 billion</span> miles of driver data. The next closest competitor Waymo is at a distant 20 million miles. With a monopoly in the making in the smart mobile sector, the incentives are perfectly aligned for them to usher in a <span className="text-gray-700 font-semibold">terrifying new regime of mobility censorship</span> (if social media companies do it, why wont they?). CarsDAO is a Decentralized Autonomous Organization formed to be an influential body in the automobile sector and have the ability to apply collective pressure when they try to push the limits.
              </p>
